...
const ESSENTIALS: WordItem[] = [
  { id: "1", kr: "몸", roman: "mom", fr: "corps", say: "몸" },
  { id: "2", kr: "머리", roman: "meori", fr: "tête", say: "머리" },
  { id: "3", kr: "목", roman: "mok", fr: "gorge / cou", say: "목" },
  { id: "4", kr: "배", roman: "bae", fr: "ventre", say: "배" },
  { id: "5", kr: "등", roman: "deung", fr: "dos", say: "등" },
  { id: "6", kr: "손", roman: "son", fr: "main", say: "손" },
  { id: "7", kr: "발", roman: "bal", fr: "pied", say: "발" },
  { id: "8", kr: "눈", roman: "nun", fr: "œil", say: "눈" },
  { id: "9", kr: "귀", roman: "gwi", fr: "oreille", say: "귀" },
  { id: "10", kr: "병원", roman: "byeongwon", fr: "hôpital", say: "병원" },
  { id: "11", kr: "약국", roman: "yakguk", fr: "pharmacie", say: "약국" },
  { id: "12", kr: "약", roman: "yak", fr: "médicament", say: "약" },
];
...
const QUIZ_ITEMS: QuizItem[] = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explain: "머리 = tête ; 머리가 아파요 = j’ai mal à la tête.",
  },
  {
    id: "q3",
  ...
  return (
    <BlurView intensity={80} tint="dark" style={styles.blockCard}>
      <LinearGradient
        ...
        style={StyleSheet.absoluteFill}
      />
      <Text style={styles.blockTitle}>Formule utile</Text>
      <Text style={styles.blockSubtitle}>
        “X가/이 아파요” veut dire “j’ai mal à X”. Exemple : 머리가 아파요 pour
        la tête, 배가 아파요 pour le ventre.
      </Text>
    </BlurView>
  );
}
...
function VocabGrid({ items }: { items: WordItem[] }) {
  return (
    <BlurView intensity={80} tint="dark" style={styles.blockCard}>
      ...
      <Text style={styles.blockSubtitle}>
        Parties du corps, pharmacie, hôpital et mots de survie très utiles.
      </Text>
      ...
      <Pressable
        onPress={() => speakKo("몸 머리 목 배 등 손 발 눈 귀 병원 약국 약")}
        style={({ pressed }) => [
