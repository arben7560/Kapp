...
export default function TravelCyber() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <LinearGradient
          colors={["rgba(5,5,12,0.58)", "rgba(10,12,35,0.76)"]}
          style={ABSOLUTE_FILL}
        />
        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          >
            ...
            <View style={styles.heroSection}>
              <AppText variant="screenTitle" style={styles.heroTitle}>Voyage</AppText>
              ...
              <BlurView intensity={40} tint="dark" style={styles.glassCard}>
                ...
                <View style={styles.cardHeader}>
                  <View style={styles.liveTag}>
                    ...
                    <AppText variant="label" style={styles.liveText}>TRAVEL PROTOCOL</AppText>
                  </View>
            ...
            {/* --- PHRASES SECTION --- */}
            <AppText variant="sectionLabel" style={styles.sectionLabel}>DIALOGUES DE TRANSIT</AppText>
            {PHRASES.map((item) => (
              <Pressable
                key={item.id}
            ...
            {/* --- MINI QUIZ SECTION --- */}
            <AppText variant="sectionLabel" style={styles.sectionLabel}>CONTRÔLE DES CONNAISSANCES</AppText>
