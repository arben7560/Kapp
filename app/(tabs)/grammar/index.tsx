...
export default function GrammarHubScreen() {
  ...
  }, [completedContentRefs, grammarProgress, setTrack]);
              ...
              <View style={styles.overviewTop}>
                <View style={styles.overviewCopy}>
                  ...
                  <AppText variant="bodySecondary" tone="muted">
                    {GRAMMAR_STAGE_BY_ID[nextStageId].title} · {GRAMMAR_STAGE_BY_ID[nextStageId].communicativeGoal}
                  </AppText>
                </View>
                ...
                <View style={[styles.grid, responsive.isTablet && styles.gridTablet]}>
                  {chapter.stageIds.map((stageId) => {
                    ...
                    return (
                      ...
                      >
                        <BlurView intensity={44} tint="dark" style={styles.stageCard}>
                          <View style={[styles.stageAccent, completed && styles.stageAccentCompleted]} />
                          <View style={styles.stageNumber}>
                            <AppText variant="label" align="center" style={styles.stageNumberText}>
                          ...
                          <AppText aria-hidden variant="symbol" style={locked ? styles.lockedText : styles.arrow}>
                            {locked ? "⌁" : completed ? "✓" : "›"}
                          </AppText>
                        </BlurView>
                      </Pressable>
