...
const NEXT_HANGUL_ROUTE = "/(tabs)";
const NEXT_HANGUL_LABEL = "REVENIR À L'ACCUEIL";
const CURRENT_HANGUL_MODULE_ID = "hangul_batchim";
const HANGUL_PREREQUISITES = [
  ...
  { id: "hangul_consonants_tense", title: "Consonnes doubles" },
];
        ...
        >
          <View style={styles.header}>
            <Pressable onPress={() => router.back()} style={styles.backBtn}>
              ...
              <AppText variant="sectionLabel" lineContract="singleLine" style={styles.backText}>FINALES</AppText>
            </Pressable>
          ...
          <View style={styles.grid}>
            <View style={styles.toolboxHeader}>
              <AppText variant="sectionTitle" style={styles.sectionTitle}>BATCHIM TOOLBOX</AppText>
            </View>
              ...
              <AppText variant="body" style={styles.teaserText}>
                ...
                {shouldSuggestNextSection
                  ? hasSkippedPrerequisites
                    ...
                    : "Bravo, tu as validé tout le parcours Hangul avec au maximum une erreur par thème. Reviens à l'accueil pour choisir librement la suite de ton apprentissage."
                  : shouldRetryBeforeNextSection
