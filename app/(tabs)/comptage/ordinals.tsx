      ...
      expressions: [
        {
          ...
          mean: "Le premier",
          context:
            "Désigne la première place ou le vainqueur dans un classement ou une compétition.",
        },
        {
          word: "이등",
          rom: "i-deung",
          mean: "Le deuxième",
          context:
            "Désigne la deuxième place dans un classement, un concours ou un examen.",
        },
