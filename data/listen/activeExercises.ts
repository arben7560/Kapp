  ...
  dictation: [
    {
      ...
      audioAsset: "assets/audio/listen/cafe-dictation-01.mp3",
    ...
    },
    {
      ...
      instruction: "Écoute, puis choisis la phrase prononcée.",
      audioAsset: "assets/audio/listen/cafe-dictation-02.mp3",
      options: [
        "아이스 아메리카노 주세요.",
        "따뜻한 아메리카노 주세요.",
        "아이스 카페라떼 주세요.",
    ...
    },
    {
      ...
      instruction: "Écoute, puis choisis la phrase prononcée.",
      audioAsset: "assets/audio/listen/metro-dictation-03.mp3",
      options: [
        "이곳으로 가세요.",
        "저쪽으로 가세요.",
        "오른쪽으로 가세요.",
    ...
    },
    {
      ...
      title: "Repère la question",
      instruction: "Écoute, puis choisis la phrase prononcée.",
      audioAsset: "assets/audio/listen/shop-dictation-04.mp3",
    ...
    },
    {
      ...
      instruction: "Écoute, puis choisis la phrase prononcée.",
      audioAsset: "assets/audio/listen/hotel-dictation-05.mp3",
  ...
  situation: [
    {
      ...
      audioAsset: "assets/audio/listen/bbq-situation-01.mp3",
      sourceText: "몇 분이세요?",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/cafe-situation-02.mp3",
      sourceText: "뭐 드릴까요?",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/metro-situation-03.mp3",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/shop-situation-04.mp3",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/street-situation-05.mp3",
      sourceText: "쭉 가서 오른쪽으로 가세요.",
  ...
  gap: [
    {
      ...
      audioAsset: "assets/audio/listen/restaurant-gap-01.mp3",
      before: "삼겹살 ",
      after: " 주세요.",
      options: ["2인분", "3인분", "4인분"],
      answer: "2인분",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/cafe-gap-02.mp3",
      before: "아이스 ",
      after: " 주세요.",
    ...
    },
    {
      ...
      instruction: "Écoute, puis complète la phrase.",
      audioAsset: "assets/audio/listen/shop-gap-03.mp3",
      before: "",
      after: " 계산할게요.",
    ...
    },
    {
      ...
      instruction: "Écoute, puis choisis le mot manquant.",
      audioAsset: "assets/audio/listen/metro-gap-04.mp3",
      before: "",
      after: "에서 내려요.",
      options: ["홍대입구", "강남", "서울역"],
      answer: "홍대입구",
    ...
    },
    {
      ...
      instruction: "Écoute, puis complète la phrase.",
      audioAsset: "assets/audio/listen/hotel-gap-05.mp3",
      before: "",
      after: "했어요.",
      options: ["예약", "결제", "체크인"],
      answer: "예약",
  ...
  order: [
    {
      ...
      audioAsset: "assets/audio/listen/metro-order-01.mp3",
      words: ["가세요", "이쪽으로", "쭉"],
      answer: ["쭉", "이쪽으로", "가세요"],
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/cafe-order-02.mp3",
      words: ["주세요", "아이스", "아메리카노"],
    ...
    },
    {
      ...
      instruction: "Écoute, puis reconstruis la phrase.",
      audioAsset: "assets/audio/listen/shop-order-03.mp3",
      words: ["얼마예요", "이거", "?"],
      answer: ["이거", "얼마예요", "?"],
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/restaurant-order-04.mp3",
      words: ["주세요", "물", "좀"],
      answer: ["물", "좀", "주세요"],
    ...
    },
    {
      ...
      instruction: "Écoute, puis reconstruis la phrase.",
      audioAsset: "assets/audio/listen/street-order-05.mp3",
      words: ["어디예요", "화장실이", "?"],
      answer: ["화장실이", "어디예요", "?"],
  ...
  reaction: [
    {
      ...
      audioAsset: "assets/audio/listen/cafe-reaction-01.mp3",
      sourceText: "뭐 드릴까요?",
      options: ["아이스 아메리카노 주세요.", "카드로 계산할게요.", "포장해 주세요."],
      answer: 0,
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/restaurant-reaction-02.mp3",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/shop-reaction-03.mp3",
      sourceText: "뭐 찾으시는 거 있으세요?",
      options: ["괜찮아요, 그냥 볼게요.", "중간 사이즈로 주세요.", "카드로 할게요."],
      answer: 0,
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/hotel-reaction-04.mp3",
      sourceText: "예약하셨어요?",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/street-reaction-05.mp3",
      sourceText: "여기서 오른쪽으로 가세요.",
