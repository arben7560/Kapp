...
export const EXERCISES_BY_KIND: Record<ExerciseKind, ListenExercise[]> = {
  ...
  situation: [
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/mwo-deurilkkayo-1.mp3",
      sourceText: "뭐 드릴까요?",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/kadeuro-hasigesseoyo-hyeongeumeuro-hasigesseoyo.mp3",
    ...
    },
    {
      ...
      audioAsset: "assets/audio/listen/jjuk-gaseo-oreunjjogeuro-gaseyo.mp3",
  ...
  reaction: [
    {
      ...
      audioAsset: "assets/audio/listen/mwo-deurilkkayo-2.mp3",
      sourceText: "뭐 드릴까요?",
