  ...
  scenes: [
    {
      ...
      questions: [
        ...
        q("cvc-layout", "batchim", "Quel batchim entends-tu ?", "ㅇ", [o("ㄴ"), o("ㅁ"), o("ㅇ")], "Dans 강, tu entends le son ng, représenté par ㅇ.", ["ㄱ", "ㅏ", "ㅇ"], undefined, "강"),
        q("cvc-t", "batchim", "Quel son final entends-tu ?", "ㄷ", ESSENTIAL_FINAL_SOUNDS.map((item) => o(item)), "갇 se termine par ㄷ.", ["ㄱ", "ㅏ", "ㄷ"], undefined, "갇"),
        q("cvc-ng", "batchim", "Quel batchim entends-tu ?", "ㄴ", [o("ㄱ"), o("ㄴ"), o("ㅁ")], "Dans 간, tu entends le son n, représenté par ㄴ.", ["ㄱ", "ㅏ", "ㄴ"], undefined, "간"),
        q("cvc-p", "batchim", "Quel batchim entends-tu ?", "ㅂ", [o("ㄱ"), o("ㅂ"), o("ㅁ")], "Dans 갑, tu entends le son p final, représenté par ㅂ.", ["ㄱ", "ㅏ", "ㅂ"], undefined, "갑"),
    ...
    },
    {
      ...
      instruction: "Les cartes font entendre de vraies syllabes fermées pour identifier le son final. Chaque famille regroupe plusieurs graphies qui produisent la même réalisation.",
      accent: "#22D3EE",
      ...
      cards: cards([
        ...
        ["fg-t", "ㄷ · ㅅ · ㅆ · ㅈ · ㅊ · ㅌ · ㅎ", undefined, "→ ㄷ final", "Sept graphies, un T final coupé.", "갇"],
        ["fg-l", "ㄹ", undefined, "→ ㄹ final", "L final.", "갈"],
        ["fg-m", "ㅁ", undefined, "→ ㅁ final", "M final.", "감"],
        ["fg-p", "ㅂ · ㅍ", undefined, "→ ㅂ final", "Deux graphies, un P final coupé.", "갑"],
        ["fg-ng", "ㅇ", undefined, "→ ㅇ final", "NG final.", "강"],
      ], "consonant"),
      questions: [
        q("fs-book", "batchim", "Quel son final entends-tu ?", "ㄱ", ESSENTIAL_FINAL_SOUNDS.map((item) => o(item)), "Dans 각, tu entends la réalisation finale ㄱ.", ["ㄱ", "ㅏ", "ㄱ"], undefined, "각"),
    ...
    },
    {
      ...
      questions: [
        ...
        q("br-mul", "read", "Écoute puis choisis le mot.", "물", [o("문"), o("물"), o("밤")], "Le mot entendu est 물, qui se termine par ㄹ.", ["ㅁ", "ㅜ", "ㄹ"], undefined, "물"),
        q("br-bam", "read", "Écoute et distingue 밤 de 밥.", "밤", [o("밤"), o("밥"), o("강")], "밤 finit par m ; 밥 finit par p.", ["ㅂ", "ㅏ", "ㅁ"], undefined, "밤"),
        q("br-jip", "batchim", "Quel batchim entends-tu ?", "ㅂ", [o("ㅂ"), o("ㅁ"), o("ㄹ")], "Dans 집, tu entends le son p final, représenté par ㅂ.", ["ㅈ", "ㅣ", "ㅂ"], undefined, "집"),
        ...
        q("br-gang", "batchim", "Quel son final entends-tu ?", "ㅇ", [o("ㄴ"), o("ㅇ"), o("ㅁ")], "Dans 강, tu entends le son ng, représenté par ㅇ.", ["ㄱ", "ㅏ", "ㅇ"], undefined, "강"),
      ],
    },
    {
      id: "liaison",
      ...
      questions: [
        ...
        q("link-final-k", "batchim", "Écoute 한국어 : quel son final se rattache à 어 ?", "ㄱ", [o("ㄱ"), o("ㄴ"), o("ㅇ")], "Dans 한국어, le ㄱ de 국 se rattache à 어 : 한구거.", ["ㅎ", "ㅏ", "ㄴ", "ㄱ", "ㅜ", "ㅇ", "ㅓ"], undefined, "한국어"),
      ],
    },
  ],
};
