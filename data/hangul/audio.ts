...
export const HANGUL_AUDIO_BY_TEXT: Readonly<Record<string, HangulAudioSource>> = {
  ...
  "사과와 우유를 먹어요": require("../../assets/audio/hangul/sagwagauyuleulmeogeoyo.mp3"),
  ...
  "아이가 와요": require("../../assets/audio/hangul/aigaoayo.mp3"),
  ...
  "여우가 와요": require("../../assets/audio/hangul/yeougaoayo.mp3"),
  ...
  "아이가 집에 가요": require("../../assets/audio/hangul/aigajibegayo.mp3"),
