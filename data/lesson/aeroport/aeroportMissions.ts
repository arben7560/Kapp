...
export const aeroportMissions: AeroportMission[] = [
  ...
  },
  {
    ...
    access: "premium",
    duration: "4-6 min",
    objective: "Gérer la carte de transport.",
  ...
  },
  {
    ...
    access: "premium",
    duration: "4-6 min",
    objective: "Choisir le train adapté.",
  ...
  },
  {
    ...
    subtitle: "Vérifie où monter.",
    access: "premium",
    duration: "3-5 min",
    objective: "Rejoindre le bon quai.",
    goals: ["Quai", "Vérifier", "Monter"],
    scenarioKey: "find_platform",
  },
  {
    id: "lost-help",
    title: "Demander de l'aide",
    subtitle: "Tu es perdu dans l’aéroport.",
    access: "premium",
    duration: "3-5 min",
