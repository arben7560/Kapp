...
> = {
  "sentence-order": [
    order("coffee-order", "Moi, je bois du café.", ["저는", "커피를", "마셔요."], "Le prédicat 마셔요 se place à la fin de la phrase coréenne.", "predicate-final"),
    choose("syntax", "home-order", "« Moi, je rentre à la maison. »", "저는 집에 가요.", ["가요 저는 집에.", "저는 가요 집에.", "집에 가요 저는."], "Le groupe de destination 집에 précède le prédicat final 가요.", "predicate-final", undefined, "Choisis la phrase dont le prédicat est correctement placé à la fin."),
    choose("syntax", "book-order", "« Je lis un livre à la bibliothèque. »", "도서관에서 책을 읽어요.", ["도서관에서 읽어요 책을.", "읽어요 도서관에서 책을.", "책을 읽어요 도서관에서."], "Le lieu et l’objet précèdent le prédicat final 읽어요.", "predicate-final", undefined, "Choisis la phrase dont le prédicat est correctement placé à la fin."),
    choose("syntax", "friend-order", "« Je rencontre un ami demain. »", "내일 친구를 만나요.", ["내일 만나요 친구를.", "만나요 내일 친구를.", "친구를 만나요 내일."], "Le repère temporel et l’objet précèdent le prédicat final 만나요.", "predicate-final", undefined, "Choisis la phrase dont le prédicat est correctement placé à la fin."),
    choose("syntax", "subject-omission", "Réponse naturelle à « Où allez-vous ? »", "학교에 가요.", ["저는 학교에 가요.", "학교에 가요 저는.", "가요 학교에."], "Le sujet déjà compris peut être omis ; 가요 reste en fin de phrase.", "subject-omission", "La question vient d’identifier clairement la personne qui répond ; la consigne exige une réponse sans sujet répété.", "Choisis la réponse naturelle avec le prédicat final et sans sujet inutile."),
  ],
  ...
  "copula-ieyo-yeyo": [
    ...
    gap("forms", "book-batchim", "책__.", "이에요", ["예요", "이예요", "아니에요"], "책 possède un 받침 : la copule attendue est 이에요.", "batchim"),
    gap("forms", "friend-vowel", "친구__.", "예요", ["이에요", "이예요", "아니에요"], "친구 finit par une voyelle : la copule attendue est 예요.", "no-batchim"),
    gap("forms", "name-batchim", "이름은 수진__.", "이에요", ["예요", "이예요", "입니다"], "수진 se termine par ㄴ : le nom possède donc un 받침 et prend 이에요.", "batchim", undefined, "Repère la terminaison du nom et choisis la copule correcte."),
  ],
  ...
  "topic-eun-neun": [
    gap("particles", "je-vowel", "저__ 학생이에요.", "는", ["은", "를", "가"], "저 finit par une voyelle : la particule de thème est 는.", "no-batchim"),
    gap("particles", "today-batchim", "오늘__ 쉬어요.", "은", ["는", "을", "이"], "오늘 possède un 받침 : la particule de thème est 은.", "batchim", "Tu opposes aujourd’hui aux autres jours."),
    gap("particles", "coffee-vowel", "커피__ 안 마셔요.", "는", ["은", "를", "가"], "커피 finit par une voyelle : le thème contrastif prend 는.", "no-batchim", "Tu bois d’autres boissons, mais pas de café."),
    gap("particles", "book-batchim", "책__ 여기 있어요.", "은", ["는", "을", "이"], "책 possède un 받침 : le thème déjà évoqué prend 은.", "batchim", "Vous cherchez plusieurs objets ; tu reprends le livre comme thème."),
    gap("particles", "friend-vowel", "친구__ 한국 사람이에요.", "는", ["은", "를", "가"], "친구 finit par une voyelle : la particule de thème est 는.", "no-batchim"),
  ],

  "subject-i-ga": [
    gap("particles", "rain-vowel", "비__ 와요.", "가", ["이", "는", "를"], "비 finit par une voyelle : le sujet de 와요 prend 가.", "no-batchim"),
    gap("particles", "time-batchim", "시간__ 없어요.", "이", ["가", "은", "을"], "시간 possède un 받침 : le sujet de 없어요 prend 이.", "batchim"),
    gap("particles", "bus-vowel", "버스__ 와요.", "가", ["이", "는", "를"], "버스 finit par une voyelle : le sujet de l’arrivée prend 가.", "no-batchim"),
    gap("particles", "book-batchim", "책__ 있어요.", "이", ["가", "은", "을"], "책 possède un 받침 : le sujet de 있어요 prend 이.", "batchim"),
    gap("particles", "friend-vowel", "친구__ 한국어를 공부해요.", "가", ["이", "는", "를"], "친구 finit par une voyelle : le sujet focalisé prend 가.", "no-batchim", "Tu réponds à la question « Qui étudie le coréen ? »."),
  ],
  ...
  "existence-isseoyo-eopseoyo": [
    ...
    choose("forms", "identity-vs-existence", "이건 커피__.", "가 아니에요", ["가 없어요", "가 있어요", "를 안 해요"], "아니에요 nie l’identité de la boisson ; 없어요 nierait son existence.", "identity-vs-existence", "La boisson est bien présente, mais ce n’est pas du café."),
  ],
  ...
  "object-eul-reul": [
    gap("particles", "book-batchim", "책__ 읽어요.", "을", ["를", "은", "이"], "책 possède un 받침 : l’objet direct prend 을.", "batchim"),
    gap("particles", "coffee-vowel", "커피__ 마셔요.", "를", ["을", "는", "가"], "커피 finit par une voyelle : l’objet direct prend 를.", "no-batchim"),
    gap("particles", "meal-batchim", "밥__ 먹어요.", "을", ["를", "은", "이"], "밥 possède un 받침 : l’objet direct prend 을.", "batchim"),
    gap("particles", "korean-vowel", "한국어__ 공부해요.", "를", ["을", "는", "가"], "한국어 finit par une voyelle : l’objet direct prend 를.", "no-batchim"),
    gap("particles", "film-vowel", "영화__ 봐요.", "를", ["을", "는", "가"], "영화 finit par une voyelle : l’objet direct prend 를.", "no-batchim"),
  ],
  ...
  "destination-time-e": [
    gap("particles", "seoul-destination", "서울__ 가요.", "에", ["에서", "을", "부터"], "Avec 가요, 에 marque ici la destination Séoul.", "destination"),
    gap("particles", "school-destination", "학교__ 와요.", "에", ["에서", "를", "까지"], "Avec 와요, 에 marque l’endroit vers lequel on vient.", "destination"),
  ...
  "present-a-eoyo": [
    transform("conjugation", "eat-present", "먹다 → ?", "먹어요", ["먹아요", "먹었어요", "먹을 거예요"], "먹다 prend -어요 au présent : 먹어요.", "present-eoyo"),
    transform("conjugation", "go-present", "가다 → ?", "가요", ["가어요", "갔어요", "갈 거예요"], "가다 se contracte en 가요 au présent.", "present-ayo"),
    transform("conjugation", "drink-present", "마시다 → ?", "마셔요", ["마시요", "마셨어요", "마실 거예요"], "마시다 devient 마셔요 au présent poli courant.", "present-eoyo"),
    transform("conjugation", "study-present", "공부하다 → ?", "공부해요", ["공부하요", "공부했어요", "공부할 거예요"], "하다 devient 해요 : 공부해요.", "present-haeyo"),
    transform("conjugation", "read-present", "읽다 → ?", "읽어요", ["읽아요", "읽었어요", "읽을 거예요"], "읽다 prend -어요 au présent : 읽어요.", "present-eoyo"),
  ],
  ...
  "negation-an": [
    ...
    choose("modality", "not-spicy-short", "이 음식은 __.", "안 매워요", ["못 매워요", "맵지 않아요", "아니에요"], "Pour produire la négation courte demandée, on place 안 devant 매워요.", "short-negation", "Décris le plat avec la forme négative courte étudiée.", "Utilise précisément la négation courte 안 + prédicat."),
  ...
  "copula-negation-anieyo": [
    ...
    gap("forms", "not-doctor", "의사__.", "가 아니에요", ["이 아니에요", "안 예요", "가 없어요"], "의사 finit par une voyelle : le nom prend 가 devant 아니에요.", "no-batchim", undefined, "Complète l’identification négative avec la forme de 아니에요 correcte."),
    ...
    choose("forms", "absence-vs-identity", "« Ce n’est pas mon sac. »", "제 가방이 아니에요.", ["제 가방이 없어요.", "제 가방을 안 해요.", "제 가방이 못 해요."], "아니에요 nie l’identité ; 없어요 exprimerait l’absence du sac.", "copula-negation"),
  ],
  ...
  "request-v-a-eo-juseyo": [
    ...
    choose("modality", "item-vs-action", "문을 __.", "열어 주세요", ["주세요", "여세요", "열고 싶어요"], "Avec un verbe, la demande d’action se forme en -아/어 주세요.", "action-request", "Tu sollicites l’aide de l’employé : tu veux qu’il ouvre la porte.", "Choisis la demande d’action explicite, et non une simple instruction."),
  ],

  "polite-instruction-euseyo": [
    transform("modality", "sit-invitation", "앉다 → ?", "앉으세요", ["앉세요", "앉아 주세요", "앉을까요"], "앉다 se termine par une consonne et prend 으세요.", "batchim", "En tant qu’hôte, tu invites poliment ton visiteur à s’asseoir.", "Forme l’invitation ou l’instruction polie en -(으)세요."),
    transform("modality", "go-instruction", "가다 → ?", "가세요", ["가으세요", "가 주세요", "갈까요"], "가다 finit par une voyelle et prend 세요.", "no-batchim", "Tu indiques poliment au visiteur d’aller de ce côté.", "Forme l’instruction polie en -(으)세요."),
    transform("modality", "read-instruction", "읽다 → ?", "읽으세요", ["읽세요", "읽어 주세요", "읽을까요"], "읽다 possède un 받침 et prend 으세요.", "batchim", "Le professeur donne à la classe la consigne de lire le texte.", "Forme l’instruction polie en -(으)세요."),
    transform("modality", "come-invitation", "오다 → ?", "오세요", ["오으세요", "와 주세요", "올까요"], "오다 finit par une voyelle et prend 세요.", "no-batchim", "À l’accueil, tu invites poliment le visiteur à venir par ici.", "Forme l’invitation polie en -(으)세요."),
  ...
  "direction-means-ro-euro": [
    ...
    gap("particles", "right-batchim", "오른쪽__ 가세요.", "으로", ["로", "에", "에서"], "오른쪽 se termine par le 받침 ㄱ : la direction prend 으로.", "direction-batchim"),
    gap("particles", "card-vowel", "카드__ 계산해요.", "로", ["으로", "에", "에서"], "카드 finit par une voyelle : le moyen de paiement prend 로.", "means-no-batchim"),
  ],

  "desire-go-sipeoyo": [
    transform("modality", "eat-desire", "먹다 → ?", "먹고 싶어요", ["먹을 거예요", "먹을게요", "먹을까요"], "Le radical 먹- reçoit 고 싶어요 pour exprimer un souhait.", "desire"),
    transform("modality", "go-desire", "가다 → ?", "가고 싶어요", ["갈 거예요", "갈게요", "갈까요"], "Le souhait du locuteur se forme avec 가고 싶어요.", "desire"),
    transform("modality", "buy-desire", "사다 → ?", "사고 싶어요", ["살 거예요", "살게요", "살까요"], "사다 devient 사고 싶어요 pour dire ce que l’on veut acheter.", "desire"),
    transform("modality", "learn-desire", "배우다 → ?", "배우고 싶어요", ["배울 거예요", "배울게요", "배울까요"], "배우고 싶어요 exprime le souhait d’apprendre.", "desire"),
  ...
  "ability-eul-su-isseoyo": [
    ...
    transform("modality", "go-ability", "가다 → ?", "갈 수 있어요", ["가도 돼요", "가고 싶어요", "못 가요"], "가다 finit par une voyelle : 갈 수 있어요.", "ability", undefined, "Forme une phrase qui exprime une possibilité réelle."),
    ...
    choose("modality", "speak-ability", "한국어를 __.", "말할 수 있어요", ["말해도 돼요", "말하고 싶어요", "말해야 해요"], "말할 수 있어요 décrit une capacité linguistique.", "ability"),
  ],
  ...
  "permission-a-eodo-dwaeyo": [
    ...
    transform("modality", "photo-permission", "사진을 찍다 → ?", "사진을 찍어도 돼요?", ["사진을 찍을 수 있어요?", "사진을 찍으세요", "사진을 찍어야 해요"], "찍어도 돼요? demande l’autorisation de prendre une photo.", "permission", "Dans un musée, tu demandes à un gardien si les photos sont autorisées.", "Forme une demande d’autorisation."),
  ...
  "past-ass-eosseoyo": [
    transform("conjugation", "eat-past", "먹다 → ?", "먹었어요", ["먹았어요", "먹어요", "먹을 거예요"], "먹다 prend -었어요 au passé : 먹었어요.", "past-eosseoyo"),
    transform("conjugation", "go-past", "가다 → ?", "갔어요", ["가었어요", "가요", "갈 거예요"], "가다 prend -았어요 et se contracte en 갔어요.", "past-ass-eosseoyo"),
    transform("conjugation", "see-past", "보다 → ?", "봤어요", ["봐요", "볼 거예요", "보았을 거예요"], "보다 se contracte en 봤어요 au passé poli courant.", "past-ass-eosseoyo"),
    transform("conjugation", "study-past", "공부하다 → ?", "공부했어요", ["공부하었어요", "공부해요", "공부할 거예요"], "하다 devient 했어요 au passé : 공부했어요.", "past-haesseoyo"),
    transform("conjugation", "drink-past", "마시다 → ?", "마셨어요", ["마샀어요", "마셔요", "마실 거예요"], "마시다 devient 마셨어요 au passé poli courant.", "past-eosseoyo"),
  ],

  "future-eul-geoyeyo": [
    transform("conjugation", "eat-future", "먹다 → ?", "먹을 거예요", ["먹을게요", "먹었어요", "먹어요"], "먹다 possède un 받침 et prend 을 거예요.", "future-batchim", undefined, "Annonce un projet déjà prévu avec -(으)ㄹ 거예요."),
    transform("conjugation", "go-future", "가다 → ?", "갈 거예요", ["갈게요", "갔어요", "가요"], "가다 finit par une voyelle et devient 갈 거예요.", "future-no-batchim", undefined, "Annonce un projet déjà prévu avec -(으)ㄹ 거예요."),
    transform("conjugation", "read-future", "읽다 → ?", "읽을 거예요", ["읽을게요", "읽었어요", "읽어요"], "읽다 possède un 받침 et prend 을 거예요.", "future-batchim", undefined, "Annonce un projet déjà prévu avec -(으)ㄹ 거예요."),
    transform("conjugation", "study-future", "공부하다 → ?", "공부할 거예요", ["공부할게요", "공부했어요", "공부해요"], "공부하다 finit par une voyelle et devient 공부할 거예요.", "future-no-batchim", undefined, "Annonce un projet déjà prévu avec -(으)ㄹ 거예요."),
  ...
  "alternative-ina-animyeon": [
    gap("forms", "coffee-vowel", "커피__ 차 있어요?", "나", ["이나", "하고", "도"], "커피 finit par une voyelle : le choix entre deux noms se marque avec 나.", "no-batchim"),
    gap("forms", "bread-batchim", "빵__ 케이크 주세요.", "이나", ["나", "하고", "도"], "빵 possède un 받침 : le choix entre deux noms se marque avec 이나.", "batchim"),
    gap("forms", "bus-vowel", "버스__ 지하철로 가요.", "나", ["이나", "하고", "만"], "버스 finit par une voyelle : 버스나 relie deux moyens possibles.", "no-batchim"),
    gap("forms", "water-batchim", "물__ 차를 마셔요.", "이나", ["나", "하고", "만"], "물 possède un 받침 : 물이나 relie deux boissons possibles.", "batchim"),
  ...
  "noun-link-hago-irang": [
    gap("forms", "coffee-and-cake", "커피__ 케이크 주세요.", "하고", ["이나", "도", "만"], "하고 relie ici deux noms commandés ensemble.", "coordination-hago"),
    gap("forms", "bread-with-milk", "빵__ 우유 주세요.", "하고", ["이나", "도", "만"], "하고 signifie ici « et » entre les deux produits.", "coordination-hago"),
  ...
  "native-numbers": [
    gap("forms", "one-cup", "커피 __ 잔 주세요.", "한", ["하나", "일", "첫"], "Devant un classificateur, 하나 devient 한.", "attributive-native-number"),
  ...
  "classifiers-basic": [
    gap("forms", "coffee-cup", "커피 한 __ 주세요.", "잔", ["개", "명", "장"], "잔 est le classificateur des boissons servies en tasse ou en verre.", "drink-classifier"),
    gap("forms", "people-count", "두 __이에요.", "명", ["개", "잔", "장"], "명 compte les personnes dans un registre courant.", "people-classifier"),
    gap("forms", "ticket-count", "표 두 __ 주세요.", "장", ["개", "명", "잔"], "장 compte les objets plats comme les billets.", "flat-classifier"),
    gap("forms", "apple-count", "사과 세 __ 주세요.", "개", ["명", "잔", "장"], "개 est le classificateur générique adapté aux pommes.", "generic-classifier"),
    gap("forms", "portion-count", "삼겹살 2__ 주세요.", "인분", ["개", "잔", "장"], "인분 compte les portions prévues pour des personnes.", "portion-classifier"),
  ],
  ...
  "range-buteo-kkaji": [
    gap("particles", "hours-range-start", "아홉 시__ 다섯 시까지 일해요.", "부터", ["에", "에서", "동안"], "부터 marque le point de départ de la plage horaire.", "range-start"),
    gap("particles", "hours-range-end", "아홉 시부터 다섯 시__ 일해요.", "까지", ["에", "에서", "동안"], "까지 marque le point d’arrivée de la plage horaire.", "range-end"),
    gap("particles", "days-range-start", "월요일__ 금요일까지 일해요.", "부터", ["에", "에서", "동안"], "월요일 est le début de l’intervalle : 월요일부터.", "range-start"),
    gap("particles", "days-range-end", "월요일부터 금요일__ 일해요.", "까지", ["에", "에서", "동안"], "금요일 est la fin de l’intervalle : 금요일까지.", "range-end"),
  ...
  "additive-do": [
    ...
    gap("particles", "me-too", "저__ 가요.", "도", ["만", "는", "를"], "저도 signifie « moi aussi » et ajoute le locuteur au groupe.", "additive", "Un ami a annoncé qu’il part ; tu indiques que tu pars aussi."),
    ...
    gap("particles", "coffee-too", "커피__ 마셔요.", "도", ["만", "는", "를"], "커피도 signifie que le café s’ajoute aux autres boissons consommées.", "additive", "Tu bois déjà du thé et tu précises que tu bois aussi du café."),
  ...
  "restrictive-man": [
    ...
    gap("particles", "today-only", "오늘__ 쉬어요.", "만", ["도", "은", "부터"], "오늘만 limite le repos à aujourd’hui.", "restrictive", "Tu travailles les autres jours et te reposes seulement aujourd’hui."),
  ...
  "comparison-boda-deo-jeil": [
    ...
    gap("syntax", "bag-comparison", "이 가방이 저 가방보다 __ 가벼워요.", "더", ["제일", "만", "도"], "더 marque le degré supérieur dans cette comparaison entre deux sacs.", "comparison"),
  ...
  "honorific-si": [
    ...
    gap("register", "honorific-people", "몇 __이세요?", "분", ["명", "개", "잔"], "분 est le classificateur honorifique pour compter des personnes.", "honorific-lexicon", "Au restaurant, l’employé s’adresse respectueusement aux clients."),
    choose("register", "teacher-present", "선생님은 교실에 __.", "계세요", ["있어요", "계셨어요", "계실 거예요"], "계세요 est la forme honorifique présente de 있어요 pour une personne respectée.", "honorific-lexicon", "Tu indiques respectueusement que le professeur se trouve actuellement dans la salle."),
    gap("register", "customer-name", "__이 어떻게 되세요?", "성함", ["이름", "말씀", "나이"], "성함 est le mot honorifique employé pour demander le nom du client.", "honorific-lexicon", "Un employé demande respectueusement le nom d’un client."),
